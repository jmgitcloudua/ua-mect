function [sol] = BuildSolutionGreedyEnergy(nNodes, Links, T, L, sP, nSP, C)
    ...
    % C contains the maximum link capacity

    % returns a solution built with Greedy Randomized strategy minimizing
    % the energy comsuntion of a solution while respecting the maximum link
    % capacity 
