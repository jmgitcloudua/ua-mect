...
public class KeyValueList<E> {
  ...
  public String toString(String left, String sep, String right) {
    // Complete this function (11.2)
      return start + toString(mid, first) + end;
  }
  
  private String toString(String mid, KeyValueNode<E> n){
		if(n.next == null) return "(" + n.key + ", " + n.elem + ")";
		return "(" + n.key + ", " + n.elem + ")" + mid + toString(mid, n.next);
  }
