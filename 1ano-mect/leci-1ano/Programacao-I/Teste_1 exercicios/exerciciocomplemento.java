...
//~ public class exerciciocomplemento{
	...
	//~ public static void main (String [] args){
		...
		//~ do{
			//~ escolha = (int)ler("nao ler valores");
		//~ }while(escolha !=1 && escolha != 2);
		
		//~ do{
			//~ xI = ler("Valor de X inicial");
			//~ xF = ler("Valor de X final ");
		//~ }while(xI >= xF);
		//~ npM = (int)ler("Numero de pontos da funcao:");
	//~ }
