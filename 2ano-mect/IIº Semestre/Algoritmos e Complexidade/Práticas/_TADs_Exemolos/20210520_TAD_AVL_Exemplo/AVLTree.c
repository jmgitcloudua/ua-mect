...
int AVLTreeEquals(const AVLTree *root1, const AVLTree *root2)
{
  ...
  return AVLTreeEquals(root1->left, root2->left) && AVLTreeEquals(root1->right, root2->right);
}
...
int AVLTreeMirrors(const AVLTree *root1, const AVLTree *root2)
{
  ...
  return AVLTreeMirrors(root1->left, root2->left) && AVLTreeMirrors(root1->right, root2->right);
}
...
int AVLTreeGetNumberOfNodes(const AVLTree *root)
{
  ...
  return 1 + AVLTreeGetNumberOfNodes(root->left) + AVLTreeGetNumberOfNodes(root->right);
}
...
int AVLTreeGetMin(const AVLTree *root)
{
  ...
  return AVLTreeGetMin(root->left);
}
...
void AVLTreeTraverseInPREOrder(AVLTree *root, void (*function)(ItemType *p))
{
  ...
  AVLTreeTraverseInPREOrder(root->left, function);

  AVLTreeTraverseInPREOrder(root->right, function);
}
...
void AVLTreeTraverseINOrder(AVLTree *root, void (*function)(ItemType *p))
{
  ...
  AVLTreeTraverseINOrder(root->left, function);

  function(&(root->item));

  AVLTreeTraverseINOrder(root->right, function);
}
...
void AVLTreeTraverseInPOSTOrder(AVLTree *root, void (*function)(ItemType *p))
{
 ...
 AVLTreeTraverseInPOSTOrder(root->left, function);

  AVLTreeTraverseInPOSTOrder(root->right, function);
...
void AVLTreeTraverseINOrderWithSTACK(AVLTree *root, void (*function)(ItemType *p)) {
...
int AVLTreeContains(const AVLTree *root, const ItemType item)
{
  ...
  return AVLTreeContains(root->left, item) || AVLTreeContains(root->right, item);
}
